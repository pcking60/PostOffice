    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ServiceDetailId = c.Int(nullable: false),
                        PropertyServiceId = c.Int(nullable: false),
                        CreatedBy = c.String(),
                        CreatedDate = c.DateTime(),
                        MetaDescription = c.String(),
                        MetaKeyWord = c.String(),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.PropertyServices", t => t.PropertyServiceId, cascadeDelete: true)
                .ForeignKey("dbo.ServiceDetails", t => t.ServiceDetailId, cascadeDelete: true)
                .Index(t => t.ServiceDetailId)
                .Index(t => t.PropertyServiceId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PropertyServiceDetails", "ServiceDetailId", "dbo.ServiceDetails");
            DropForeignKey("dbo.PropertyServiceDetails", "PropertyServiceId", "dbo.PropertyServices");
            ...
            DropIndex("dbo.PropertyServiceDetails", new[] { "PropertyServiceId" });
            DropIndex("dbo.PropertyServiceDetails", new[] { "ServiceDetailId" });
